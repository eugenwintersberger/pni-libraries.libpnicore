...
//-----------------------------------------------------------------------------
template<typename OT> class data_object_test : public CppUnit::TestFixture
{
...
//-----------------------------------------------------------------------------
template<typename OT> void data_object_test<OT>::setUp()
{
...
//-----------------------------------------------------------------------------
template<typename OT> void data_object_test<OT>::tearDown()
{
    
}

//-----------------------------------------------------------------------------
template<typename OT> void data_object_test<OT>::test_construction()
{
...
//-----------------------------------------------------------------------------
template<typename OT> void data_object_test<OT>::test_copy_and_move()
{
    std::cout<<BOOST_CURRENT_FUNCTION<<std::endl;
