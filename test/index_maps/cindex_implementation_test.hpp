...
//! 
//! This template is a general approach to test index policy maps. The entire 
//! test can be parametrized via its template parameters.
//!
...
template<
         ...
         size_t... INDEXES
        > 
class cindex_implementation_test: public CppUnit::TestFixture 
{
        typedef cindex_implementation_test<PIMPT,TPARAMS,STYPE,ITYPE,
