...
#include "array_view_unary_arithmetic_test.hpp"



#define DYNARRAY_TEST_REGISTRATION(type)\
static CPPUNIT_NS::AutoRegisterSuite< array_view_unary_arithmetic_test<dynamic_array<type> > >  \
             CPPUNIT_MAKE_UNIQUE_NAME(autoRegisterRegistry__ )

#define FIXARRAY_TEST_REGISTRATION(type,ndims)\
static CPPUNIT_NS::AutoRegisterSuite< array_view_unary_arithmetic_test<fixed_dim_array<type,ndims> > >  \
             CPPUNIT_MAKE_UNIQUE_NAME(autoRegisterRegistry__ )

template<typename T> using static_a = static_array<T,2,3,5>;
#define STATARRAY_TEST_REGISTRATION(type)\
static CPPUNIT_NS::AutoRegisterSuite< array_view_unary_arithmetic_test<static_a<type> > >  \
             CPPUNIT_MAKE_UNIQUE_NAME(autoRegisterRegistry__ )
