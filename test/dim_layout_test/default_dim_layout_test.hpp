...
//! 
class default_dim_layout_test : public CppUnit::TestFixture
{
        CPPUNIT_TEST_SUITE(default_dim_layout_test);
        ...
        typedef default_dim_layout::storage_type vector_type;
        default_dim_layout layout1,layout2;

        bool check_rank(const default_dim_layout &l,size_t r);
    public:
        void setUp();
        void tearDown();
