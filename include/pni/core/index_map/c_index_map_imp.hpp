...
namespace core{
    ...
    class c_index_map_imp
    {
        ...
        public:
            ...
            //! 
            //! In order to be contiguous the shape of a selection (in the 
            //! original array) has to satisfy several conditions. The number 
            //! of elements of the selection must be either 1 or match the 
            //! number of elements in the original array. In addition, once 
            //! an index other than one has been found all subsequent element 
            //! numbers must match those of the original array.
            //! 
