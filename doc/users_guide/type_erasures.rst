...
To use type erasures include the :file:`/pni/core/type_erasures.hpp` at the 
...
a type erasure. 
*libpnicore* for this purpose provides the :cpp:class:`value_ref` erasure. It stores 
...
.. literalinclude:: ../examples/type_erasure3.cpp
   :language: cpp
   :lines: 25-62
   :linenos:
   :lineno-match:
   :caption: see :file:`examples/type_erasure3.cpp` for full code
...
.. literalinclude:: ../examples/record.dat
   :language: text
...
.. literalinclude:: ../examples/type_erasure_record.cpp
   :language: cpp
   :lines: 26-42
   :linenos:
   :lineno-match:
   :caption: see :file:`examples/type_erasure_record.cpp` for full code
