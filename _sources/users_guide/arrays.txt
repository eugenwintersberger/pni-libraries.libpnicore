...
.. literalinclude:: ../examples/array_create.cpp
   :language: cpp
   :linenos:
   :lineno-match:
   :lines: 28-50
   :caption: see :file:`examples/array_create.cpp`
...
.. literalinclude:: ../examples/array_inquery.cpp
   :language: cpp
   :lines: 28-56
   :linenos:
   :lineno-match:
   :caption: see :file:`examples/array_inquery.cpp` for full code
...
.. literalinclude:: ../examples/array_linear_access.cpp
   :language: cpp
   :lines: 28-60
   :linenos:
   :lineno-match:
   :caption: see :file:`examples/array_linear_access.cpp` for full code
...
.. literalinclude:: ../examples/array_stl.cpp
   :language: cpp
   :lines: 28-59
   :linenos:
   :lineno-match:
   :caption: see :file:`examples/array_stl.cpp` for full code
...
.. literalinclude:: ../examples/array_multiindex.cpp
   :language: cpp
   :lines: 28-69
   :linenos:
   :lineno-match:
   :caption: see :file:`examples/array_multiindex.cpp` for full code
...
:cpp:class:`slice` to the *()* operator of an array type. Slices in *libpnicore* work
pretty much the same as in python. Lets have a look on the following example

.. literalinclude:: ../examples/array_view.cpp
   :language: cpp
   :lines: 28-63
   :linenos:
   :lineno-match:
   :caption: see :file:`examples/array_view.cpp` for full code
...
.. literalinclude:: ../examples/array_view_container.cpp
   :language: cpp
   :lines: 28-73
   :linenos:
   :lineno-match:
   :caption: see :file:`examples/array_view_container.cpp` for full code 
...
.. literalinclude:: ../examples/array_arithmetic1.cpp
   :language: cpp
   :lines: 28-50
   :linenos: 
   :lineno-match:
   :caption: see :file:`examples/array_arithmetic1.cpp`
...
.. literalinclude:: ../examples/array_arithmetic2.cpp
   :language: cpp
   :lines: 28-58
   :linenos:
   :lineno-match:
   :caption: see :file:`examples/array_arithmetic2.cpp` for full code
...
.. literalinclude:: ../examples/array_arithmetic3.cpp
   :language: cpp
   :lines: 28-139
   :linenos:
   :lineno-match:
   :caption: see :file:`examples/array_arithmetic3.cpp` for full code
