...
template<typename T> Array<T>::Array(const unsigned int &r,const unsigned int s[]):ArrayObject()
{
...
template<typename T> Array<T>::Array(const ArrayShape &s):ArrayObject()
{
...
template<typename T> Array<T>::Array(const boost::shared_ptr<ArrayShape> &s):ArrayObject()
{
...
template<typename T> Array<T>::Array(const ArrayShape &s,const Buffer<T> &b):ArrayObject()
{
